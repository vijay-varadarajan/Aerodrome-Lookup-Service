from project import get_country_code, get_airports_country, get_region_code, get_airports_region, get_airports_city, search
import pytest
...
def test_get_airports_final():
    assert get_airports_city("Lt-ku", " Kaunas  ") == [{'name': 'Kaunas International Airport', 'type': 'medium_airport', 'gps code': 'EYKA'}, {'name': 'Kaunas Gamykla Airfield', 'type': 'closed', 'gps code': 'EYKG'}, {'name': 'S. Darius and S. GirÄ—nas Airfield', 'type': 'small_airport', 'gps code': 'EYKS'}]
    
    assert get_airports_city("IN-TN", "C H e n n A I") == [{'name': 'Chennai Military Hospital Helipad', 'type': 'heliport', 'gps code': ''}, {'name': 'Chennai International Airport', 'type': 'large_airport', 'gps code': 'VOMM'}, {'name': 'Tambaram Air Force Station', 'type': 'small_airport', 'gps code': 'VOTX'}]

    assert get_airports_city("US-DE", "Christiana") == [{'name': 'Eagle Run Heliport', 'type': 'closed', 'gps code': ''}]
